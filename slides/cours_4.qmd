...
Pour lire/écrire les fichiers JSON, on utilisera en priorité la librairie [`jsonlite`](https://cran.r-project.org/web/packages/jsonlite/vignettes/json-aaquickstart.html).
...
Ou laisser `{dplyr}` faire le travail avec [`{dbplyr}`](https://dbplyr.tidyverse.org/)
...
## Données ouvertes {auto-animate="true"}

Pour explorer des API web, on utilise le package [`{httr2}`](https://httr2.r-lib.org/index.html).

Ici, on requête l'[API Melodi de l'Insee](https://portail-api.insee.fr/catalog/api/a890b735-159c-4c91-90b7-35159c7c9126) sur les [données de prénoms](https://catalogue-donnees.insee.fr/fr/catalogue/recherche/DS_PRENOM) (l'exploration préalable de la doc [Swagger](https://portail-api.insee.fr/catalog/api/a890b735-159c-4c91-90b7-35159c7c9126/doc?page=ee625968-272a-4637-a259-68272aa63766) peut aider à tester sa requête).
...
Si vous avez envie de gratter encore plus le web, aller creuser les outils de scraping comme [`{rvest}`](https://rvest.tidyverse.org/index.html).
