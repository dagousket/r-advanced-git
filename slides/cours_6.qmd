---
subtitle: "Science reproductible"
---
...
Les vignettes de package peuvent aussi être générées par `quarto`. Voir l'exemple du [package quarto](https://cran.r-project.org/web/packages/quarto/vignettes/hello.html) lui-même.
...
Exemple : ce cours est hébergé sur un [site](https://github.com/dagousket/r-advanced-git/blob/master/_quarto.yaml) quarto. Les [slides](https://github.com/dagousket/r-advanced-git/blob/master/slides/cours_1.qmd) des cours sont aussi écrites en quarto avec revealjs, les [sujets d'exercices](https://github.com/dagousket/r-advanced-git/blob/master/exercises/sem_1.qmd) en quarto - pdf.
...
```{r}
#| eval: true
sessionInfo() # ou devtools::session_info()
```
