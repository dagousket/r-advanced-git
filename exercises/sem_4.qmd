...
1. Créez un dossier data à la racine du projet dans lequel vous copierez les fichiers dé-zippés. Dans le fichier `.gitignore`, ajoutez la ligne "data/" puis sauvegardez. À quoi sert cette étape ?

2. Importez les différents fichiers en utilisant les librairies appropriées. Appelez la table `df_DEC_DEP`, la table résultant de la lecture du fichier `DEC_DEP.json`. Conservez ce schéma de nommage pour les 4 fichiers.
